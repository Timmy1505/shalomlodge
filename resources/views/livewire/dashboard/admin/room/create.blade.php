<div class="space-y-8">
    ...
    <form class="space-y-4" action="#" method="POST" wire:submit.prevent='store'>
        <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="form-control sm:col-span-2">
                ...
                <div wire:ignore><textarea wire:model='explanation' name="explanation" id="explanation"></textarea>
                </div>
                @error('explanation')
                <span class="invalid">{{ $message }}</span>
                @enderror
            ...
            <div class="form-control">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <label for="{{ $facility->code }}"
                        class="bg-gray-100 py-2 px-4 rounded-tr-xl rounded-bl-xl flex items-center gap-1 cursor-pointer">
                        <input wire:model="selectedFacilities.{{ $facility->code }}" value="{{ $facility->code }}"
                            class="checkbox cursor-pointer" type="checkbox" name="selectedFacilities[]"
                            id="{{ $facility->code }}">
            ...
            <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                ...
                x-on:livewire-upload-progress="progress = $event.detail.progress" class="sm:col-span-2 space-y-4">
                ...
                @if ($image)
                <div wire:loading.class="blur-sm" wire:target='image'
                    class="aspect-[16/9] rounded-tr-2xl rounded-bl-2xl overflow-hidden w-full">
    ...
    <div x-data="{ open: false }">
        <div x-show="open" @room:created.window="open = true" style="display: none"
