<main class="mt-28 mb-20">
    <div class="container px-8 mx-auto space-y-10">
        <div class="space-y-2">
            <h1 class="sm:text-5xl text-gray-800 text-3xl font-['poppins'] font-black capitalize after:content-[''] after:block after:w-10 after:h-1 after:bg-gray-800 after:rounded-full">
                Room Choices For You</h1>
            <p class="tracking-wide text-gray-600 sm:text-base text-sm">We have a choice of {{ $rooms->count() }}
                different room types that you can choose according to your needs</p>
        </div>
        <div class="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8">
            ...
            <div class="space-y-4">
                ...
                <span class="text-sm text-gray-600 bg-gray-200 py-2 text-center rounded-tr-xl rounded-bl-xl block">{{ (int) $room->total_rooms -  (int) $room->reservations->count()}}
